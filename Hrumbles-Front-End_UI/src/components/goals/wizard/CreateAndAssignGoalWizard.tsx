...
const CreateAndAssignGoalWizard: React.FC<CreateAndAssignGoalWizardProps> = ({ onClose }) => {
      ...
      <div className="pt-6">
        ...
        <div className="relative min-h-[450px] overflow-hidden">
          <AnimatePresence initial={false} custom={direction}>
            ...
            >
              {step === 1 && <Step1_SelectDepartmentAndMetric onNext={handleStep1Next} onClose={onClose} />}
              ...
              {step === 3 && goalDefinition && period && <Step3_AssignEmployees goalDefinition={goalDefinition} period={period} department={department} onBack={handleBackToStep2} onClose={onClose} />}
            </motion.div>
          </AnimatePresence>
        </div>
      </div>
