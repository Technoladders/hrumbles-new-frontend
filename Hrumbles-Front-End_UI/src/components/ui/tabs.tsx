...
>(({ className, ...props }, ref) => (
  <div className="border-none border-gray-200 bg-white/50 backdrop-blur-sm rounded-t-lg p-2 ">
    <TabsPrimitive.List
      ref={ref}
      className={cn(
...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      "inline-flex h-10 items-center justify-center rounded-md bg-white p-1 text-white",
      className
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.Trigger
    ref={ref}
    className={cn(
      "inline-flex items-center justify-center bg-gray-200 whitespace-nowrap rounded-sm px-3 py-1.5 text-foreground text-sm font-medium ring-offset-background transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 data-[state=active]:bg-purple data-[state=active]:text-white data-[state=active]:shadow-sm",
      className
    )}
    {...props}
  />
...
export { Tabs, TabsList, TabsTrigger, TabsContent, TabsList1, TabsTrigger1 }
