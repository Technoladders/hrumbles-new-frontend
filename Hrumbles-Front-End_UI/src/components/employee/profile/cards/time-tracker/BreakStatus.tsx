...
export const BreakStatus: React.FC<BreakStatusProps> = ({
  ...
  const getPauseIcon = (reason?: string) => {
    switch (reason) {
      case "Lunch Break":
        return <UtensilsCrossed className="h-4 w-4 text-white" />;
      case "Coffee Break":
  ...
  return (
    <div className="flex flex-col items-center">
      <div className="flex items-center gap-2 bg-white/20 backdrop-blur-sm rounded-full px-4 py-2 text-[#0055D4]">
