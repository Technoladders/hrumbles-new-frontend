    ...
    <div className="min-h-screen bg-gradient-to-b from-gray-50 to-gray-100 p-6 md:p-10 animate-fade-in">
      <main className="w-full max-w-8xl mx-auto space-y-8">
        ...
        <div>
          ...
          <p className="text-sm text-gray-500 mt-2">Analyze contacts added to the system by each creator.</p>
        </div>
        ...
        <div className="grid gap-4 md:grid-cols-4">
          <Card className="shadow-xl border-none bg-white overflow-hidden transition-all duration-300 hover:shadow-2xl">
            <CardContent className="p-6 flex items-center justify-between">
              <div>
                <p className="text-sm font-medium text-gray-500 mb-2">Contacts in Period</p>
          ...
          <Card className="shadow-xl border-none bg-white overflow-hidden transition-all duration-300 hover:shadow-2xl">
            <CardContent className="p-6 flex items-center justify-between">
              <div>
                <p className="text-sm font-medium text-gray-500 mb-2">Total All-Time Contacts</p>
                <h3 className="text-2xl font-bold text-gray-800">{totalContactCount}</h3>
          ...
          <Card className="shadow-xl border-none bg-white overflow-hidden transition-all duration-300 hover:shadow-2xl">
            <CardContent className="p-6 flex items-center justify-between">
              <div>
                ...
                <p className="text-xs text-gray-500 mt-1">with {aggregatedData[0]?.count || 0} contacts added</p>
              </div>
                ...
                <Table>
                  <TableHeader>
                    <TableRow className="bg-gray-50">
                      ...
                      <TableHead className="text-center font-medium text-gray-500 px-4 py-2">Contacts Added</TableHead>
