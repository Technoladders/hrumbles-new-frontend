// src/components/reports/CompaniesReport.tsx
...
const CompaniesReport: React.FC = () => {
    ...
    return (
      <div className="space-y-6">
         <Card>
          <CardHeader>
            <CardTitle>Companies Contribution Report</CardTitle>
            <p className="text-sm text-muted-foreground">
              Analyze companies added to the system by each creator.
            </p>
          </CardHeader>
          <CardContent>
             ...
             <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4 mb-6">
               <Card>
                  <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
                      <CardTitle className="text-sm font-medium">Companies in Period</CardTitle>
              ...
              <Card>
                  <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
                      <CardTitle className="text-sm font-medium">Total All-Time Companies</CardTitle>
                      <SlidersHorizontal className="h-4 w-4 text-muted-foreground" />
                  </CardHeader>
                  <CardContent>
                      <div className="text-2xl font-bold">{totalCompanyCount}</div>
              ...
              <Card>
                  ...
                  <CardContent>
                      ...
                      <p className="text-xs text-muted-foreground">with {aggregatedData[0]?.count || 0} companies added</p>
                  </CardContent>
              </Card>
            </div>
          </CardContent>
            ...
            <CardContent>
              <ResponsiveContainer width="100%" height={400}>
                <BarChart data={aggregatedData} layout="vertical" margin={{ top: 5, right: 30, left: 20, bottom: 5 }}>
                  ...
                  <Legend />
                  <Bar dataKey="count" name="Companies Added" fill="#8884d8" />
                </BarChart>
              </ResponsiveContainer>
            </CardContent>
          </Card>
                   ...
                   <div className="rounded-md border max-h-[440px] overflow-y-auto">
                      <Table>
                          <TableHeader className="sticky top-0 bg-background">
                              ...
                              <TableHead>Companies Added</TableHead>
