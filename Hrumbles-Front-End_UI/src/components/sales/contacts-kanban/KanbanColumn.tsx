...
export const KanbanColumn: React.FC<KanbanColumnProps> = ({ stage, contacts, onDrop }) => {
  ...
  return (
        <div
            ref={drop}
            // Changed: Set a fixed width and allow it to fill the parent's height.
            className={cn(
                "w-72 h-full flex-shrink-0 bg-slate-100/60 rounded-lg flex flex-col transition-colors",
        ...
        >
            ...
            {/* Changed: This container will now scroll vertically if content overflows. */}
