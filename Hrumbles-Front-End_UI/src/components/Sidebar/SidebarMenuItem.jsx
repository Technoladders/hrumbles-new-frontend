...
import { FaUserShield, FaProjectDiagram, FaUserTie, FaSearch, FaAddressBook } from 'react-icons/fa';
...
const masterMenuItems = [
  ...
  { icon: FaAddressBook, label: "Profile Hub", path: "/profile-hub", suite: "RECRUITMENT", permission: "access_profile_hub" },
