        ...
        <div className="flex items-center gap-1.5">
          {stats && (
            <div className="hidden sm:flex items-center gap-3 mr-2">
              <span className="text-[9px] text-violet-200"><span className="font-bold text-white">{Number(stats.email_revealed).toLocaleString()}</span> email</span>
      ...
      <div className="flex flex-1 min-h-0 overflow-hidden relative">
        ...
        <button
          ...
          className={cn(
            ...
            "hover:border-violet-400 hover:text-violet-600 hover:shadow-violet-100 text-slate-400 rounded-r-full",
          )}
