...
import ContactStatusReport from '@/components/reports/ContactsStatusReport'; // New component
import CompaniesStatusReport from '@/components/reports/CompaniesStatusReport'; // New component
