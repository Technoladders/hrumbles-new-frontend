...
import { History, Download, User, Users, Building2, Calendar, Hash } from 'lucide-react';
    ...
    return (
      <Card className="border-red-200 bg-red-50">
        <CardContent className="p-4 text-sm text-red-700">
           No employment history found for this UAN.
        </CardContent>
      </Card>
    );
  }
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-8">
            ...
            {fatherHusbandName !== 'N/A' && (
                <div className="flex items-start gap-3 p-3 bg-white/60 rounded-lg border border-green-100/50">
                    ...
                    <div className="min-w-0">
                        <p className="text-[10px] font-bold text-gray-500 uppercase tracking-wider mb-0.5">Father / Husband Name</p>
                        <p className="text-sm font-bold text-gray-900 break-words leading-tight">{fatherHusbandName}</p>
                    </div>
                </div>
            )}
        </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-y-3 gap-x-6 pl-7">
                  ...
                  <div className="flex items-center gap-2 text-xs">
                    ...
                    <div className="flex gap-1 text-gray-700">
                        <span className="font-semibold text-green-700">{formatDate(job.Doj)}</span>
                        <span className="text-gray-400">to</span>
                        <span className={`font-semibold ${job.DateOfExitEpf ? 'text-gray-700' : 'text-green-600'}`}>
                  ...
                  <div className="flex items-center gap-2 text-xs">
                     ...
                     <code className="font-mono bg-white px-1.5 py-0.5 rounded border border-gray-100 text-black-800 break-all">
                        {job.MemberId || 'N/A'}
                     </code>
                  </div>
              </div>
