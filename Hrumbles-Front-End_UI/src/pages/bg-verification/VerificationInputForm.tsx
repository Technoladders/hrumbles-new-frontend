...
export const VerificationInputForm = ({ title, verificationType, inputs, state, onInputChange, onVerify, onBack }: Props) => {
  ...
  return (
    <div className="space-y-4 animate-fade-in">
      ...
      <div className="mt-2">
        {result && <VerificationResultDisplay resultData={result.data} verificationType={verificationType} />}
      </div>
    </div>
  );
};
