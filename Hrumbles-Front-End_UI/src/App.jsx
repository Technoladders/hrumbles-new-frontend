// App.jsx (Modified for Redux + Profile Completion)
  ...
  element={
    <PrivateRoutes
      allowedRoles={[
        ...
        "admin",
        "employee",<Route path="/dashboard" element={<Dashboard />} />
      ]}
    />
  }
>
...
<Route path="/complete-profile" element={<CompleteYourProfile />} /> {/* ✅ CORRECT */}
  ...
  <Route element={<ProtectedRoute />}>
          <Route element={<MainLayout />}>
            {/* ========================================
                🎯 Dashboard with Profile Completion Check
                ======================================== */}
            {/* Wrap dashboard with ProtectedRoute to enforce profile completion */}
            ...
            {/* Finance & Accounts */}
            {/* 🎯 OPTIONAL: Wrap finance with profile completion check if needed */}
