...
import CreditUsagePage from "./components/candidates/zive-x/CreditUsagePage";
...
function AppContent() {
 ...
 const validateCurrentSession = useCallback(async () => {
  ...
  userRole === 'vendor' ? <VendorDashboard /> : <Dashboard />
              ...
              <Route path="/recruiter-x/credits" element={<CreditUsagePage />} />
              ...
              <Route path="/profile-hub/profile/:id" element={<TIProfilePage />} />
